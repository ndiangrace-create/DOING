...
{
  const fp=path.join(out,'doing-2.html');let html=fs.readFileSync(fp,'utf8');if(!html.includes('doing-2-home-v11.css'))html=html.replace('</head>','<link rel="stylesheet" href="/doing-2-home-v11.css?v=20260822-v11home3"></head>');if(!html.includes('doing-2-home-v11.js'))html=html.replace('</body>','<script src="/doing-2-home-v11.js?v=20260822-v11home3"></script></body>');fs.writeFileSync(fp,html);
}
{
...
console.log(JSON.stringify({result:'PASS',output:'.doing-2-site',root:'doing-2.html',routes:Object.keys(routeMap),shell:shellTargets,candyTheme:candyTargets,homeV11:true,homeLiveCards:true,homeSearchToMarket:true,marketCompact:['market-center.html','market-session.html'],memberDirectReturn:true,applicationFlow:true,applicationContract:'v12',applicationFixedProducts:'v5',workspaceMarketRouter:true},null,2));
