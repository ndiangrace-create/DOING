...
for(const asset of ['doing-kawaii-current.css','doing-home-v4.css','doing-home-current.js','doing-logo-current.webp','doing-market-current.css','doing-market-2bl-parity.css','doing-market-entry-current.js','doing-market-public-2bl.js','doing-member-workspace-fix.js','doing-system.css','doing-home-refresh.css','doing-home-refresh.js','doing-design-tokens.css','doing-pastel-pages.css','doing-attribution.js']){
...
console.log(JSON.stringify({result:'PASS',mode:'market-2bl-layout-parity',routeCount:allRoutes.length,liveRoutes:[...Object.keys(sourceRoutes),...Object.keys(transformedRoutes)],shellRoutes:Object.keys(shellRoutes),marketEntries:['/market/public/','/market/'],marketPublicSinglePage:true,marketRegistrationInline:true,marketAdminDirectLineLogin:true,market2blLayoutParity:true,consignmentCoreBacked:true,legacyRegisterInternal:true,databaseWrites:0,workerChangeScope:'none',twoBlChanges:0,logo:{bytes:logoBytes.length,width:logoWidth,height:logoHeight,sha256:logoHash}},null,2));
