...
console.log(JSON.stringify({result:'PASS',asset,targets:['/market/','/market/session/'],legacyDialogSelectorPreserved:true,legacySessionNameSelectorPreserved:true},null,2));