...
for(const label of ['DOING Market','DOING Project','DOING Booking','DOING Guide'])assert.ok(hub.includes(label),`Hub 缺少 ${label}`);
...
console.log(JSON.stringify({result:'PASS',pages:Object.values(pages),databaseSchemaChanges:0,newTables:0,existingInstructionsModified:false,worldTreeV1Preserved:true},null,2));