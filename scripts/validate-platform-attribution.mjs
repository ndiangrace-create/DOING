...
for(const token of ['hTrackPlatformAttribution','recordRegistrationAttribution','hGetPlatformAttributionReport',"case 'register'",'platform_attribution_events'])if(!worker.includes(token))fail('Worker 歸因鏈缺少：'+token);
