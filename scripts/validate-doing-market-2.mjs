...
const base=fs.readFileSync(archive+'DOING_2.0_WORLD_TREE_V1_BASELINE_20260822.md','utf8');
const v3=fs.readFileSync(archive+'DOING_2.0_WORLD_TREE_V3_MARKET_EXECUTION_20260822.md','utf8');
const v4=fs.readFileSync(archive+'DOING_2.0_WORLD_TREE_V4_MARKET_OPERATIONS_20260822.md','utf8');
const v5=fs.readFileSync(archive+'DOING_2.0_WORLD_TREE_V5_MARKET_PUBLIC_20260822.md','utf8');
...
const parity=fs.readFileSync(archive+'DOING_2.0_MARKET_2BL_UI_PARITY_20260823.md','utf8');assert.ok(parity.includes('2BL UI Parity')&&parity.includes('DOING LINE／會員登入'),'本輪 2BL UI parity checkpoint 未同步');
