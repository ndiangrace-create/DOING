...
console.log(JSON.stringify({result:'PASS',publicJourney:['選產品','選使用類型','填資料','LINE 驗證'],helperRole:'customer_service_only',applicationGate:false,moduleConfirmation:false,applyEntry:'/apply/',dbTablesAdded:0},null,2));
