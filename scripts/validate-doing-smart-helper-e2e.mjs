...
assert(home.includes('doing-about-refresh.css?v=20260817j'),'首頁未載入最新智慧申請樣式');
...
assert(css.includes('DOING 單一大型智慧介面')&&css.includes('width:min(1500px,calc(100vw - 36px))!important')&&css.includes('min-height:clamp(780px,84vh,1040px)!important')&&css.includes('height:auto!important')&&css.includes('max-height:none!important'),'電腦版智慧介面不夠寬高或仍被固定高度限制');
